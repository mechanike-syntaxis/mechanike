...
Rivet aveugle de forme A
````````````````````````

.. image:: /rivet/blind_rivet/image/iso15983A.png
   :height: 250px

Rivet aveugle de forme B
````````````````````````

.. image:: /rivet/blind_rivet/image/iso15983B.png
   :height: 250px

Définitions
```````````

- *d1* : diamètre de la tête du rivet
- *l* : longueur de la tête du rivet  

Tableau dimensions
------------------

.. include:: /rivet/blind_rivet/table/iso15983.rst.inc

.. |drilling| replace:: perçage
.. |length hole| replace:: longueur du trou
